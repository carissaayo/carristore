...
const EditProduct = ({ setOpenEditProduct, openEditProduct }) => {
  return (
    <main
      className={`${
        openEditProduct
          ? "absolute top-[4%] xs:top-[5%]  left-[5%] xs:left-[10%] sm:left-[15%] md:left-[20%] xl:left-[30%] bg-white w-[90%] xs:w-[80%] sm:w-[70%]  md:w-[60%] xl:w-[50%] h-[90%] rounded-md border transition-display duration-1000 ease-in-out"
          : "hidden"
      }`}
    >
        ...
        <div className="w-full  flex gap-10 mb-4">
          ...
          <div className="">
            <div className="w-[100px] h-[100px] rounded-2xl relative cursor-pointer   mb-3">
              <img src={foodImg} alt="" className="w-full h-full rounded-2xl" />
