...
const Hero = () => {
  return (
    <main className="2xl:section flex flex-col lg:flex-row  lg:gap-0   py-20 justify-center items-center lg:items-start lg:justify-between text-white px-16 lg:px-28 bg-primaryColor">
      <section className=" lg:flex-1 order-2 lg:order-1 text-center lg:text-left">
        ...
        <p className="font-medium sm:text-x xl:text-[24px] 2xl:text-[28px] mb-6 leading-tight md:w-[80%] lg:w-auto mx-auto lg:mx-0">
      ...
      <section className="w-[90%] md:w-[70%] lg:flex-1 order-1 lg:order-2">
