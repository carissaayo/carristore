...
import { deleteProduct, selectProductToDelete } from '../redux/reducers/userSlice';

const ProductItem = ({ setOpenEditProduct, item, setOpenConfirmDisplay }) => {
  ...
  return (
    <div className="flex items-center w-full bg-[#F5F5F5] px-4 py-3 border rounded-md font-medium mb-4 xs:gap-4 lg:gap-0 justify-between xs:justify-start">
      ...
      <p className="hidden md:block w-[26%] md:w-[20%] lg:w-[16%]">
        {category}
      </p>
