...
const ProductItem = () => {
  return (
    <div className="flex items-center w-full bg-[#F5F5F5] px-4 py-3 border rounded-md font-medium mb-4 gap-4 lg:gap-0">
      <div className="flex gap-2 w-[32%] md:w-[25%] lg:w-[20%]">
      ...
      <p className="w-[31%] md:w-[25%] lg:w-[20%]">NGN 10,000.00</p>
      <p className="w-[26%] md:w-[20%] lg:w-[16%]">My Food</p>
      <div className="flex gap-2 items-center text-[#8D8A8A]  w-[25%] md:w-[20%]  lg:w-[17%]">
